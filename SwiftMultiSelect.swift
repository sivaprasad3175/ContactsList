...
public struct SwiftMultiSelectItem{
    ...
    public var row          :   Int?
    public var isSmartcitiuser : Bool
    ...
    public init(row:Int,title:String,description:String? = nil,image:UIImage? = nil,imageURL:String? = nil,color:UIColor? = nil, userInfo:Any? = nil,isSmartCiti: Bool) {
        
        self.title = title
        self.row   = row
        self.isSmartcitiuser = isSmartCiti
