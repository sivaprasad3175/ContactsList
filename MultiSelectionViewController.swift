...
class MultiSelecetionViewController: UIViewController,UIGestureRecognizerDelegate,UISearchBarDelegate {
    ...
    var contactDictionary = [String: [SwiftMultiSelectItem]]() //TTContact is a model, it has firstName and lastName properties
    var keys = [String]()
    ...
    override func viewDidLoad() {
        ...
        createViewsAndSetConstraints()
         ...
         var temp = [String: [SwiftMultiSelectItem]]() //A temporary array
         for contact in SwiftMultiSelect.items!{
             let firstName = contact.title
